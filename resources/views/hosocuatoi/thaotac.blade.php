<div class="sidebar sidebar-main sidebar-default">
                ...
                <div id="id01" class="modall">
                    <form method="POST" id="formJoin" class="modall-contentt animatee" action="{{route('capnhaphosoungvien')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="containerr">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{$uv->diachi}}" name="diachi"> 
                                     @error('diachi')
                                                    <div class="alert alert-danger">
                                                        {{$message}}
                                                    </div>                                                    
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"  value="{{$uv->kinhnghiem}}" name="kinhnghiem">
                                    @error('kinhnghiem')
                                                    <div class="alert alert-danger">
                                                        {{$message}}
                                                    </div>                                                    
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{$uv->khuvuc}}" name="khuvuc"> 
                                     @error('khuvuc')
                                                    <div class="alert alert-danger">
                                                        {{$message}}
                                                    </div>                                                    
                                    ...
                                    <div >
                                                ...
                                                <label for="exampleInputEmail1">Ảnh CV, giấy tờ khác </label>
                                                <input type="file" class="form-control" id="exampleInputEmail1" value="{{$uv->anhgiayto}}" name="anhgiayto">
