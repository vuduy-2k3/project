              ...
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div class="form-group field-updateprofileform-short_bio">
                    <label class="control-label" for="updateprofileform-short_bio">Giấy tờ yêu cầu</label>
                   <img src="/static/assets/images/giayto/{{$chitiet->anhgiayto}}" width="100px" height="100px" style="border: 1px solid orange">
                    <p class="help-block help-block-error"></p>
